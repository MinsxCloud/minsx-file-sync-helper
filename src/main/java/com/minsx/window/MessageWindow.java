...
public class MessageWindow implements Window{
	...
	public MessageWindow(Shell parentShell) {
		...
		shell.setText("提示信息 :");
		titleLabel.setText("提示信息 :");

		Label lblNewLabel_1 = new Label(shell, SWT.NONE);
		lblNewLabel_1.setImage(SWTResourceManager.getImage(MessageWindow.class, "/org/eclipse/wb/swt/MsgBoxIcon.png"));
		lblNewLabel_1.setBounds(23, 65, 51, 49);
		...
		messageLabel.setBounds(94, 77, 254, 64);
